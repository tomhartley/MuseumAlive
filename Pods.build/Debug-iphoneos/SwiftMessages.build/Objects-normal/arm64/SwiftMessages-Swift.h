...
/// \param backgroundView The view to be installed as a subview and
/// assigned to the <code>backgroundView</code> property.
///
- (void)installBackgroundView:(UIView * _Nonnull)backgroundView;
