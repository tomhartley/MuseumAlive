...
- (void)vuforiaEAGLView:(VuforiaEAGLView*)view didTouchDown:(SCNHitTestResult *)res;
- (void)vuforiaEAGLView:(VuforiaEAGLView*)view didTouchUp:(SCNHitTestResult *)res;
...
@property (nonatomic)SKScene* overlayScene;
