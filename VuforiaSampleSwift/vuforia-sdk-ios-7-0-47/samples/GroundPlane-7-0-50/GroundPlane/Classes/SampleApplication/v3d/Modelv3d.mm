...
- (bool) initShaders {
    ...
    self.objMtlProgramID = [SampleApplicationShaderUtils createProgramWithVertexShaderFileName:@"DiffuseLightMaterials.vertsh"
                                                                   fragmentShaderFileName:@"DiffuseLightMaterials.fragsh"];
